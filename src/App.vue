...
<v-app id="dayspan" v-cloak>
  ...
  <ds-calendar-app ref="app"
    ...
    <template slot="eventPopover" slot-scope="slotData">
      <ds-calendar-event-popover v-bind="slotData"
      :read-only="readOnly"
      @finish="saveState"></ds-calendar-event-popover>
    </template>
    ...
    <template slot="eventCreatePopover" slot-scope="{placeholder, calendar}">
      ...
      @create-popover-closed="saveState"></ds-calendar-event-create-popover>
    </template>

    <template slot="eventTimeTitle" slot-scope="{calendarEvent, details}">
      <div>
        <v-icon class="ds-ev-icon" v-if="details.icon" size="14"
    ...
    <template slot="drawerBottom">
      <div class="pa-3">
        ...
        <v-btn class="ma-2" outlined color="indigo" v-on:click="clearAll">Outlined Button</v-btn>
      </div>
    </template>
